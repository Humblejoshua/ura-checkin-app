(() => {
  ...
  function showApp() {
    ...
    if (mode === 'attendance') {
      ...
      document.getElementById('attScreen').classList.add('active');
      renderAtt();
    } else {
      ...
      document.getElementById('mealScreen').classList.add('active');
      renderMeal();
    }
  ...
  window.switchTab = function (tab) {
    ...
    if (tab === 'main') {
      document.getElementById(mode === 'attendance' ? 'attScreen' : 'mealScreen').classList.add('active');
